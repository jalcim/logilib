...
if __name__ == "__main__":
    ...
    top_1_mod_1.set("o_out", am.Signal(2))
    top_1_mod_2 = Module("gate_and", p_WAY=2, p_WIRE=1)
    top_1_mod_2.set("o_out", am.Signal(2))
