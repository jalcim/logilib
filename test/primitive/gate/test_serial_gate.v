...
//   gate_not  #(.WAY(WAY)) inst0(out_not ,  e1);
//   gate_buf  #(.WAY(WAY)) inst6(out_buf ,  e1);
...
//   gate_xor  #(.BEHAVIORAL(1), .WAY(WAY)) b_gate_xor_inst (out_xor,   {e3, e2, e1});
//   gate_xnor #(.BEHAVIORAL(1), .WAY(WAY)) b_gate_xnor_inst(out_xnor,  {e3, e2, e1});
