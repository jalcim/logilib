...
module test_serial_gate;
   ...
   serial_nor  #(.WAY(WAY)) gate_nor_inst   (out_nor   , e1);
   serial_nand #(.WAY(WAY)) gate_nand_inst  (out_nand  , e1);
   ...
   serial_nor  #(.WAY(WAY)) b_gate_nor_inst (b_out_nor , e1);
   serial_nand #(.WAY(WAY)) b_gate_nand_inst(b_out_nand, e1);
