...
module test_parallel_gate;
   ...
   parallel_nand #(.WAY(WAY), .WIRE(WIRE)) parallel_nand_inst(out_nand, in);
   parallel_nor  #(.WAY(WAY), .WIRE(WIRE)) parallel_nor_inst (out_nor,  in);
   ...
   parallel_nand #(.WAY(WAY), .WIRE(WIRE)) b_gate_nand_inst(b_out_nand, in);
   parallel_nor  #(.WAY(WAY), .WIRE(WIRE)) b_gate_nor_inst (b_out_nor,  in);
