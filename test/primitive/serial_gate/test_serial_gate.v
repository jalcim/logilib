...
module test_serial_gate;
   ...
   serial_nor  #(.BEHAVIORAL(0), .WIRE(WIRE)) gate_nor_inst   (out_nor   , e1);
   serial_nand #(.BEHAVIORAL(0), .WIRE(WIRE)) gate_nand_inst  (out_nand  , e1);
   ...
   serial_nor  #(.BEHAVIORAL(1), .WIRE(WIRE)) b_gate_nor_inst (b_out_nor , e1);
   serial_nand #(.BEHAVIORAL(1), .WIRE(WIRE)) b_gate_nand_inst(b_out_nand, e1);
